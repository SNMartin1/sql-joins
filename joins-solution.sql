...
SELECT "products"."id", "warehouse_product"."product_id", "warehouse"."id", "warehouse_product"."warehouse_id", "warehouse"."warehouse"
FROM "products" Join "warehouse_product" ON "products"."id" = "warehouse_product"."product_id"
JOIN "warehouse" ON "warehouse"."id" = "warehouse_product"."warehouse_id" WHERE 
"products"."description" ILIKE 'che%';
...
FROM "products" Join "warehouse_product" ON "products"."id" = "warehouse_product"."product_id"
JOIN "warehouse" ON "warehouse"."id" = "warehouse_product"."warehouse_id" WHERE 
"products"."description" ILIKE '%pep%';
